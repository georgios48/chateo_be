...
# Hostname "chateo_postgres" only resolves inside Docker. For `alembic` on your machine,
# set ALEMBIC_DATABASE_URL (e.g. 127.0.0.1 and the host port from compose).
migration_database_url = os.getenv("ALEMBIC_DATABASE_URL") or env_config.database_url
